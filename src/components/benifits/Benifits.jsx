    ...
    <div className="container-fluid mt-5">
        <div className="row row-col-autos-1 row-col-autos-md-8 mt-5 justify-content-center">
            <div className="col-auto rounded-circle shadow p-3 mb-5 bg-body-tertiary rounded ms-5">
              <i className="fa-solid fa-cube fs-1" style={{color: "#000000"}}></i>             
            </div>
           ...
           <div className="col-auto rounded-circle shadow p-3 mb-5 bg-body-tertiary rounded ms-5">
              <i className="fa-regular fa-credit-card fs-1" style={{color: "#000000"}}></i>             
            </div>
           <div className="col-auto ms-3">
           ...
           <div className="col-auto rounded-circle shadow p-3 mb-5 bg-body-tertiary rounded ms-5">
              <i className="fa-solid fa-person-walking-arrow-loop-left fs-1" style={{color: "#000000"}}></i>             
            </div>
           <div className="col-auto ms-3">
           ...
           <div className="col-auto rounded-circle shadow p-3 mb-5 bg-body-tertiary rounded ms-5">
              <i className="fa-solid fa-headset fs-1" style={{color: "#000000"}}></i>             
            </div>
           <div className="col-auto ms-3">
