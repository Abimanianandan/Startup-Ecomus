              ...
              <div className="card shadow p-4 mb-5 bg-body-tertiary rounded position-relative best">
                ...
                <div className="icons-container position-absolute d-flex justify-content-center ms-4">
                  ...
                  <Link to="/ordermanagement">
                    <i
                      className="fa-regular fa-handshake ms-2 p-2 shadow-lg p-3 mb-5 bg-body-tertiary rounded  icon"
                      style={{
                        backgroundColor: "whitesmoke",
                        borderRadius: "5px",
                        color: "black",
                ...
                <div className="card-body text-center">
                  ...
                  >
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{ border: red && "1px solid black", color: "red" }}
                      onMouseEnter={handleRed}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: white && "1px solid black",
                        color: "white",
                      }}
                      onMouseEnter={handleWhite}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
            ...
            <div className="col-sm-3 col-md-5 col-lg-3 d-flex justify-content-center">
              <div className="card shadow p-4 mb-5 bg-body-tertiary rounded position-relative  best">
                ...
                <div className="card-body text-center">
                  ...
                  <div
                    className="circle-colors d-flex justify-content-evenly"
                    style={{ cursor: "pointer" }}
                  >
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle blue"
                      style={{
                        border: blue && "1px solid black",
                        color: "rgb(161,161,250)",
                      }}
                      onMouseEnter={handleBlue}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle black"
                      style={{ border: black1 && "1px solid black" }}
                      onMouseEnter={handleBlack1}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle orange"
                      style={{
                        border: orange && "1px solid black",
                        color: "orange",
                      }}
                      onMouseEnter={handleOrange}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle green"
                      style={{
                        border: green && "1px solid black",
                        color: "rgb(127, 213, 127)",
                      }}
                      onMouseEnter={handleGreen}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle brown"
                      style={{
                        border: brown && "1px solid black",
                        color: "rgb(167, 126, 126)",
                      }}
                ...
                <div className="card-body text-center">
                  ...
                  >
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: black2 && "1px solid black",
                        color: "black",
                      }}
                      onMouseEnter={handleBlack2}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: white1 && "1px solid black",
                        color: "white",
                      }}
                ...
                <div className="card-body text-center">
                  ...
                  >
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: black3 && "1px solid black",
                        color: "black",
                      }}
                      onMouseEnter={handleBlack3}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: white2 && "1px solid black",
                        color: "white",
                      }}
                ...
                <div className="card-body text-center">
                  ...
                  >
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: black4 && "1px solid black",
                        color: "black",
                      }}
                      onMouseEnter={handleBlack4}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: orange1 && "1px solid black",
                        color: "orange",
                      }}
                      onMouseEnter={handleOrange1}
                    ></i>
                    <i
                      className="fa-solid fa-circle p-1 rounded-circle"
                      style={{
                        border: white3 && "1px solid black",
                        color: "white",
                      }}
