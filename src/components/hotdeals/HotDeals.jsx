...
<h1 className="display-4 display-sm-3 display-md-2 display-lg-1 text-center mt-5">Hot Deals</h1>
      <div className="row mt-5 hotdeals-containers" style={{flexWrap:"nowrap",gap:"2px"}}>    
          ...
          <div className="card shadow p-4 mb-5 bg-body-tertiary rounded position-relative">
            ...
            <div className="card-body text-center">
               <h6 className='card-title'>Case with MagSafe</h6>
                ...
                <button onClick={()=>handleBuy({name:'Case with MagSafe',price:'$19.99'})}>buy</button>   
            </div>
          </div>
        </div>
        <div className="col-sm-3 col-md-5 col-lg-3">
      ...
      <div className="whatsappredirection">
{/* //whatsappredirection */}
{selectedProduct&&(
...
// import image3 from '../hotdeals/hotdealsimgs/headphone-white.jpg';
// import image4 from '../hotdeals/hotdealsimgs/albert-black.jpg';
// import WhatsAppRedirect from '../whatsappredirection/WhatsAppRedirect'; // Import WhatsAppRedirect component

// const HotDeals = () => {
//   const productRef = useRef(null);
//   const [rightArrow, setRightArrow] = useState(true);
//   const [leftArrow, setLeftArrow] = useState(false);
//   const [selectedProduct, setSelectedProduct] = useState(null); // To store selected product info
...
//     setSelectedProduct(product); // Set the selected product for WhatsApp redirection
//   };
...
//               <h6 className="card-title">Case with MagSafe</h6>
//               <p className="card-text">$19.99</p>
//               <button onClick={() => handleProductQuery({ name: 'Case with MagSafe', price: 19.99 })}>Productenquery</button>
//             </div>
//           </div>
//         </div>
//         {/* Other product cards */}
...
//               <h6 className="card-title">MagSafe 3 Cable</h6>
//               <p className="card-text">$39.00</p>
//               <button onClick={() => handleProductQuery({ name: 'MagSafe 3 Cable', price: 39.00 })}>Productenquery</button>
//             </div>
//           </div>
//         </div>
//         {/* More product cards */}
...
//               <h6 className="card-title">Beats Studio Buds</h6>
//               <p className="card-text">$199.00</p>
//               <button onClick={() => handleProductQuery({ name: 'Beats Studio Buds', price: 199.00 })}>Productenquery</button>
//             </div>
//           </div>
//         </div>
//       </div>
...
//         <WhatsAppRedirect
//           ProductName={selectedProduct.name}
//           ProductPtPrice={selectedProduct.price}
//         />
//       )}
//     </div>
//   );
